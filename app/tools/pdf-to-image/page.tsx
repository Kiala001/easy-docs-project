    ...
    <main className="min-h-screen bg-gradient-to-b from-background to-muted py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-2">PDF para Imagem</h1>
          <p className="text-muted-foreground">Converta páginas PDF em imagens PNG</p>
        </div>

        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              <CardTitle>Selecione seu PDF</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              >
                ...
                <p className="text-foreground font-medium">Clique ou arraste seu PDF aqui</p>
                <p className="text-sm text-muted-foreground">Máximo 50MB</p>
              </div>
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  {loading ? "Convertendo..." : "Converter para Imagem"}
                </Button>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded p-4 text-sm text-blue-900 dark:text-blue-100">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs">
                  <li>Cada página será convertida em uma imagem separada</li>
                  <li>As imagens serão baixadas em ZIP</li>
